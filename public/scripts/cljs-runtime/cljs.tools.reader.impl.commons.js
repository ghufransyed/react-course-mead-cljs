...
var G__41642 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41642;
continue;
} else {
return ch;
...
var vec__41614 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41614,(0),null);
return (match === s);
});
...
var G__41654 = (i__4737__auto___41652 + (1));
i__4737__auto___41652 = G__41654;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41627){
var G__41628 = cljs.core.first(seq41627);
var seq41627__$1 = cljs.core.next(seq41627);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41628,seq41627__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__41655__delegate = function (rdr,_){
...
var G__41655 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41656__i = 0, G__41656__a = new Array(arguments.length -  1);
while (G__41656__i < G__41656__a.length) {G__41656__a[G__41656__i] = arguments[G__41656__i + 1]; ++G__41656__i;}
  _ = new cljs.core.IndexedSeq(G__41656__a,0,null);
} 
return G__41655__delegate.call(this,rdr,_);};
G__41655.cljs$lang$maxFixedArity = 1;
G__41655.cljs$lang$applyTo = (function (arglist__41657){
var rdr = cljs.core.first(arglist__41657);
var _ = cljs.core.rest(arglist__41657);
return G__41655__delegate(rdr,_);
});
