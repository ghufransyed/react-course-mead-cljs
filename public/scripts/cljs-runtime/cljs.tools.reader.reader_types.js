...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26714 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26714(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26715 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26715(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26716 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26716(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26717 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26717(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26720 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26720(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26725 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26725(reader);
}
});
...
var G__26821 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26822 = s.append(c);
c = G__26821;
s = G__26822;
continue;
}
