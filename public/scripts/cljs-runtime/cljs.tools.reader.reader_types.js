...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41269 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41269(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41270 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41270(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41271 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41271(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41272 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41272(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41273 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41273(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41274 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41274(reader);
}
});
...
var G__41351 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41352 = s.append(c);
c = G__41351;
s = G__41352;
continue;
}
